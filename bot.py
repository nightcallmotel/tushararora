...
def is_owner(ctx):
    return ctx.message.author.id == "481712251422638101"
...
async def ownerinfo(ctx):
    ...
    embed.set_author(name=" Bot Owner Name- ﾉ尺θη シ√KARTHIK™#4769,℘ДΠD𝓓𝓐[𝓓ε𝓥],Tag<!--Back-->#1488\nID:481712251422638101,503911747292495883")
...
async def help(ctx):
    ...
    embed.add_field(name = 'MADE BY-ﾉ尺θη シ√KARTHIK™#4769 ',value ='Shows avatar',inline = False)
    await client.send_message(author,embed=embed)
...
client.run('NjEzODA0OTc3MDY4MDQ4NDA1.XV2Qtw._UencYa3XUdo3rhuUopin9zMdJM')
